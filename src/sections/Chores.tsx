          ...
          <div className="chores-card budget">
            <div className="video-container">
              <div className="card-text">
                ...
                <p>
                  Track your money so you can confirm you’re broke in an
                  organized way.
                </p>
              </div>
              <video
          ...
          <div className="chores-card iron">
            <div className="video-container">
              <div className="card-text">
                <h5>Wrinkle Wars </h5>
                <p>
                  Our app won’t press your shirts, but at least it can remind
                  someone else it’s their turn.
                </p>
              </div>
              <video
                loop
          ...
          <div className="chores-card dog">
            <div className="video-container">
              <div className="card-text">
                ...
                <p>Your dog has a strict schedule, even if you don’t.</p>
              </div>
              <video
                loop
                muted
          ...
          <div className="chores-card dishes">
            <div className="video-container">
              <div className="card-text">
                ...
                <p>
                  Dishes don’t wash themselves, and neither do your roommates.
                </p>
              </div>
              <video
                loop
          ...
          <div className="chores-card fold">
            <div className="video-container">
              <div className="card-text">
                ...
                <p>
                  Keep track of whose turn it is—so maybe, just maybe, someone
                  else will do it this time.
                </p>
              </div>
              <video
                loop
          ...
          <div className="chores-card grocery">
            <div className="video-container">
              <div className="card-text">
                ...
                <p>So no one can say "I thought you were getting that!"</p>
              </div>
              <video
                loop
                muted
